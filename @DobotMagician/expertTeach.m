...
bgcol = [1 0.90 0.70];  % background color
...
for j = 1 : n
    ...
    set(handles.edit(j), ...
        'Interruptible', 'off', ...
        'Callback', @(src,event)expertTeach_callback(src, robot.model.name, j, handles));
...
%% expertTeach Callback
function expertTeach_callback(src, name, j, handles)
